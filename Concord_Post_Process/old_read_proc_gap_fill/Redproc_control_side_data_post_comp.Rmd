...
#Tried readyproc to gap fill just control side data post compost application. Not enough data. Gapfilled it with a GAM model using stationary chamber and MET measurements. A few gaps in that data set. using ready proc to fill those remaining gaps. 
...
out.dir<-paste0(root.ditr,"16_control_side_read_proc_gf\\") ## store all output figures/files
...
fileName <- "2021-09-14_Boot_strap_Control_side_gap_filled_via_GAM.txt"
...
write.csv(CombinedData,
          paste(out.dir,Sys.Date(),"_gap_fill_control_combo_Concord.csv",sep=""),
          quote = T,
          row.names = F)
