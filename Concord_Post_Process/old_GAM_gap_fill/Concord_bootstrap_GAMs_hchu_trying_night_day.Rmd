...
for (x in n)
{
  ...
  nee.gam <-
    gam(
      NEE ~ s(Flux, k = 12) + s(VWC_Control_GF, k = 30) + s(Rg, Tair, VPD, k = 30) ,
...
night_control_tower_eosense.data$NEE_control_GF_GAM[ night_control_tower_eosense.data$NEE_control_GF_GAM > 2.623] <-NA

night_control_tower_eosense.data$NEE_control_GF_GAM[ night_control_tower_eosense.data$NEE_control_GF_GAM < 0.164  ] <-NA
...
plot(night_control_tower_eosense.data$TIMESTAMP[night_control_tower_eosense.data $ TIMESTAMP >as.POSIXct("2020-12-12") & night_control_tower_eosense.data $ TIMESTAMP <as.POSIXct("2021-04-12")],night_control_tower_eosense.data$NEE_control_GF_GAM [night_control_tower_eosense.data $ TIMESTAMP >as.POSIXct("2020-12-12") & night_control_tower_eosense.data $ TIMESTAMP <as.POSIXct("2021-04-12")],
     ...
     col ="red")
par(new= TRUE)
plot(night_control_tower_eosense.data$TIMESTAMP[night_control_tower_eosense.data $ TIMESTAMP >as.POSIXct("2020-12-12") & night_control_tower_eosense.data $ TIMESTAMP <as.POSIXct("2021-05-01")],night_control_tower_eosense.data$NEE[night_control_tower_eosense.data $ TIMESTAMP >as.POSIXct("2020-12-12") & night_control_tower_eosense.data $ TIMESTAMP <as.POSIXct("2021-04-12") & night_control_tower_eosense.data $ TIMESTAMP <as.POSIXct("2021-04-12") ],
     ylim=c (0, 3.5),
     ylab = "",
     xlab = "",
     col ="blue")
...
day_control_tower_eosense.data$NEE_control_GF_GAM[ day_control_tower_eosense.data$NEE_control_GF_GAM > 4.088] <-NA

day_control_tower_eosense.data$NEE_control_GF_GAM[ day_control_tower_eosense.data$NEE_control_GF_GAM < -8.16  ] <-NA
