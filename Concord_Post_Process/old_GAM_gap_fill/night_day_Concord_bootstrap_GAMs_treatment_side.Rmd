...
# Night_GAM_treat_post_compost$GAM_treat_GF_GAM[ Night_GAM_treat_post_compost$GAM_treat_GF_GAM > 15.007] <-NA
# 
# Night_GAM_treat_post_compost$GAM_treat_GF_GAM[ Night_GAM_treat_post_compost$GAM_treat_GF_GAM < -34.211  ] <-NA
...
# Night_GAM_treat_post_compost$upperCI[ Night_GAM_treat_post_compost$upperCI > 15.007   ] <-NA
# 
# Night_GAM_treat_post_compost$upperCI[ Night_GAM_treat_post_compost$upperCI < -34.211  ] <-NA
...
#from the data post compost application removing any data points greater than 15.07 and less than -34.211. The max and min values recorded by the tower during that time
# Night_GAM_treat_post_compost$lowerCI[ Night_GAM_treat_post_compost$lowerCI > 15.007   ] <-NA
# 
# Night_GAM_treat_post_compost$lowerCI[ Night_GAM_treat_post_compost$lowerCI < -34.211  ] <-NA
...
Day_GAM_treat_post_compost$NEE[ Day_GAM_treat_post_compost$NEE < -8.495 ] <-NA
...
#from overall data removing any points greater than 22.936
# Day_GAM_treat_post_compost$GAM_treat_GF_GAM[ Day_GAM_treat_post_compost$GAM_treat_GF_GAM > 15.007] <-NA
# 
# Day_GAM_treat_post_compost$GAM_treat_GF_GAM[ Day_GAM_treat_post_compost$GAM_treat_GF_GAM < -34.211  ] <-NA
...
#from the data post compost application removing any data points greater than 15.07 and less than -34.211. The max and min values recorded by the tower during that time
# Day_GAM_treat_post_compost$upperCI[ Day_GAM_treat_post_compost$upperCI > 15.007   ] <-NA
# 
# Day_GAM_treat_post_compost$upperCI[ Day_GAM_treat_post_compost$upperCI < -34.211  ] <-NA
...
#from the data post compost application removing any data points greater than 15.07 and less than -34.211. The max and min values recorded by the tower during that time
# Day_GAM_treat_post_compost$lowerCI[ Day_GAM_treat_post_compost$lowerCI > 15.007   ] <-NA
# 
# Day_GAM_treat_post_compost$lowerCI[ Day_GAM_treat_post_compost$lowerCI < -34.211  ] <-NA
