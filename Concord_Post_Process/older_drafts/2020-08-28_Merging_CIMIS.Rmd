...
cdata.file_combo<-paste0("2021-06-24_master_eddy_met_concord_postfiltering.csv")
...
#the intercept and slope need to be updated each time
 ...
 cimis_eddy_met$AirT_predict<- 1.34715 + 0.94891*cimis_eddy_met$air_temperature_adj
...
#neeed to update the intercept and slope each time
 ...
 cimis_eddy_met$RH_predict<- 1.313779  + 0.916979*cimis_eddy_met$RH
...
cimis_eddy_met$Rg_predict<-cimis_eddy_met$Sol.Rad* 0.888624
...
```
#gap filling with the CIMIS soil temperatures
...
cimis_eddy_met$Soil_temp_predict_15cm<-cimis_eddy_met$Soil.Temp* 1.375360 - 1.874713
...
plot(cimis_eddy_met$Soil_temp_tower_5cm)
...
#linearily expanding control side soil temp data from treatment side daat
```{r}
...
cimis_eddy_met$Soil_temp_predict_0cm_control<-cimis_eddy_met$Soil_temp_tower_0cm* 1.18482 -3.76509 
