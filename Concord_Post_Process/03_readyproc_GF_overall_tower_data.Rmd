...
root.ditr<-"C:\\Users\\tfens\\R_REPOS\\Flux_processing\\Concord_R_Code\\Concord_Post_Process\\"
data.dir<-paste0(root.ditr,"01_Data\\06_Reddy_Proc_Data\\") ## 2021-01-20_reddy_proc.txt locate
out.dir<-paste0(root.ditr,"02_output\\06_full_footprint__Gap_filled_red_proc_data\\") ## store all output figures/files
...
fileName <- "2022-11-07_reddy_proc.txt"
...
write.csv(CombinedData,
          paste(out.dir,Sys.Date(),"Gap_fill_combined_Concord.csv",sep=""),
          quote = T,
          row.names = F)
